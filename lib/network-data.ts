...
export function generateMockData() {
  const floors: FloorData[] = [
    {
      ...
      devices: [
        ...
        device({ id: "ap-102", name: "AP-Lobby-01", type: "access_point", status: "healthy", floor: 1, zone: "Lobby", room: "Main Lobby", ipAddress: "10.10.1.22", macAddress: "A8:5E:45:1B:20:12", model: "UniFi U6 Lite", firmware: "6.6.55", uptime: "45d 12h", lastSeen: "18 seconds ago", clients: 18, bandwidth: { up: 30, down: 85 }, location: { x: 61, y: 48 }, camera: { label: "Lobby camera C-02", image: "/camera/lobby.png", angle: "Wide lobby entrance view" }, maintenanceNotes: "Coverage is stable; keep current channel plan.", connectedTo: ["sw-101"] }),
    ...
    },
    {
      ...
      devices: [
        ...
        device({ id: "sw-301", name: "SW-3-Core-01", type: "switch", status: "healthy", floor: 3, zone: "Network Closet", room: "3F IT Closet", rack: "Rack 3A / U16", ipAddress: "10.10.3.2", macAddress: "04:18:D6:8A:92:01", model: "Cisco CBS350-24P", firmware: "3.3.0.16", uptime: "85d 11h", lastSeen: "10 seconds ago", cpu: 20, memory: 38, temperature: 36, location: { x: 82, y: 26 }, camera: { label: "Closet camera C-23", image: "/camera/network-closet.png", angle: "Rack side view" }, maintenanceNotes: "Healthy; next firmware review in two weeks.", connectedTo: ["rt-401", "ap-301", "ap-302"] }),
      ],
      totalClients: 35,
    ...
    },
    {
      ...
      devices: [
        ...
        device({ id: "srv-403", name: "SRV-File-01", type: "server", status: "healthy", floor: 4, zone: "Server Room", room: "Server Room", rack: "Rack S2 / U12", ipAddress: "10.10.4.103", macAddress: "3C:EC:EF:91:10:03", model: "Dell PowerEdge R550", firmware: "iDRAC 7.10", uptime: "180d 15h", lastSeen: "12 seconds ago", cpu: 40, memory: 65, temperature: 42, location: { x: 80, y: 67 }, camera: { label: "Server room C-34", image: "/camera/server-room.png", angle: "Storage rack view" }, maintenanceNotes: "File storage usage at 68%; no action needed.", connectedTo: ["sw-401"] }),
      ],
      totalClients: 28,
  ...
  const maintenanceEvents: MaintenanceEvent[] = [
    ...
    { id: "event-3", deviceId: "rt-401", title: "WAN failover test", description: "Primary and secondary WAN failover verified successfully.", timestamp: new Date(Date.now() - 3 * 24 * 60 * 60000), status: "completed" },
  ]
