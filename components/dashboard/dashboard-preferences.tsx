...
const TRANSLATIONS = {
  en: {
    ...
    seeMore: "See more",
    seeLess: "See less",
    statusHealthyHelp: "Device is responding normally with stable load and link quality.",
    statusLatencyHelp: "Device is still online, but response time, load, or link quality needs checking.",
    statusDownHelp: "Device is not responding or has a service-impacting connection problem.",
    openFloorHelp: "Open this floor's map, camera preview, and device list.",
    floorDeviceMarkerHelp: "Click this marker to inspect the device location and metrics.",
    alertAckHelp: "Mark this alert as checked after reviewing it.",
    alertDeviceHelp: "Open the affected device details.",
    loadingFloorDetails: "Loading floor details...",
    glossary: "Glossary",
    helpGlossaryBody: "Icons identify device types such as access points, switches, routers, and servers. Green means healthy, amber latency means the device is online but needs checking, and red down means the device is not responding. Ack marks an alert as reviewed, while See more expands hidden alerts or events.",
    currentFloor: "Current floor",
    previousFloor: "Previous floor",
    nextFloor: "Next floor",
    backToBuilding: "Back to building",
    hoverHintTitle: "Need help reading the dashboard?",
    hoverHintBody: "Hover status badges, floor markers, topology nodes, and alert actions to see short explanations.",
    dismiss: "Dismiss",
    download: "Download",
    upload: "Upload",
    ...
    helpAlertsBody: "Critical means service risk is high. Warning means an issue should be checked soon. Info is a maintenance or advisory message. Acknowledge alerts after checking them.",
    helpStatusBody: "Healthy devices are operating normally, latency devices have slow response, elevated load, or link issues, and down devices need immediate attention or are not responding.",
  ...
  zh: {
    ...
    seeMore: "查看更多",
    seeLess: "收起",
    statusHealthyHelp: "设备响应正常，负载和连接状态稳定。",
    statusLatencyHelp: "设备仍在线，但响应时间、负载或连接质量需要检查。",
    statusDownHelp: "设备无响应，或出现影响服务的连接问题。",
    openFloorHelp: "打开此楼层的平面图、摄像头预览和设备列表。",
    floorDeviceMarkerHelp: "点击此标记查看设备位置和指标。",
    alertAckHelp: "检查后将此警报标记为已确认。",
    alertDeviceHelp: "打开受影响设备的详情。",
    loadingFloorDetails: "正在加载楼层详情...",
    glossary: "图标说明",
    helpGlossaryBody: "图标用于区分无线 AP、交换机、路由器和服务器。绿色表示正常，橙色延迟表示设备仍在线但需要检查，红色故障表示设备无响应。确认代表已检查警报，查看更多会展开隐藏的警报或事件。",
    currentFloor: "当前楼层",
    previousFloor: "上一层",
    nextFloor: "下一层",
    backToBuilding: "返回楼栋",
    hoverHintTitle: "需要帮助阅读仪表盘？",
    hoverHintBody: "将鼠标移到状态标签、楼层标记、拓扑节点和警报按钮上，可以看到简短说明。",
    dismiss: "关闭",
    download: "下载",
    upload: "上传",
    ...
    helpAlertsBody: "严重代表服务风险较高；警告代表需要尽快检查；信息是维护或提示消息。检查后可确认警报。",
    helpStatusBody: "正常表示设备运行稳定；延迟表示响应变慢、负载较高或链路异常；故障表示需要立即处理或设备无响应。",
  ...
  ms: {
    ...
    seeMore: "Lihat lagi",
    seeLess: "Ringkaskan",
    statusHealthyHelp: "Peranti memberi respons normal dengan beban dan pautan yang stabil.",
    statusLatencyHelp: "Peranti masih dalam talian, tetapi masa respons, beban, atau kualiti pautan perlu disemak.",
    statusDownHelp: "Peranti tidak memberi respons atau mengalami masalah sambungan yang menjejaskan servis.",
    openFloorHelp: "Buka pelan tingkat, pratonton kamera, dan senarai peranti.",
    floorDeviceMarkerHelp: "Klik penanda ini untuk melihat lokasi dan metrik peranti.",
    alertAckHelp: "Tandakan amaran ini sebagai disemak selepas pemeriksaan.",
    alertDeviceHelp: "Buka butiran peranti yang terlibat.",
    loadingFloorDetails: "Memuatkan butiran tingkat...",
    glossary: "Glosari",
    helpGlossaryBody: "Ikon membezakan access point, switch, router, dan server. Hijau bermaksud sihat, amber latensi bermaksud peranti masih dalam talian tetapi perlu disemak, dan merah tergendala bermaksud peranti tidak memberi respons. Sah menandakan amaran telah disemak, manakala Lihat lagi membuka amaran atau peristiwa tersembunyi.",
    currentFloor: "Tingkat semasa",
    previousFloor: "Tingkat sebelumnya",
    nextFloor: "Tingkat seterusnya",
    backToBuilding: "Kembali ke bangunan",
    hoverHintTitle: "Perlukan bantuan membaca dashboard?",
    hoverHintBody: "Hover pada lencana status, penanda tingkat, nod topologi, dan tindakan amaran untuk melihat penerangan ringkas.",
    dismiss: "Tutup",
    download: "Muat turun",
    upload: "Muat naik",
    ...
    helpAlertsBody: "Kritikal bermaksud risiko servis tinggi. Amaran bermaksud isu perlu disemak segera. Info ialah mesej penyelenggaraan atau makluman. Sahkan selepas semakan.",
    helpStatusBody: "Sihat bermaksud peranti normal, latensi bermaksud respons perlahan, beban tinggi, atau pautan bermasalah, dan tergendala bermaksud perlu tindakan segera atau peranti tidak memberi respons.",
