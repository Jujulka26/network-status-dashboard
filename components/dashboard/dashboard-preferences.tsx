...
const TRANSLATIONS = {
  en: {
    ...
    helpAlertsBody: "Warning means the device needs attention soon. Critical means service risk is high. Info is a maintenance or advisory message. Acknowledge alerts after checking them.",
    helpStatusBody: "Healthy devices are operating normally, warning devices have elevated usage or load, critical devices need urgent action, and offline devices are not responding.",
  ...
  zh: {
    ...
    helpAlertsBody: "警告代表设备需要尽快关注；严重代表服务风险较高；信息是维护或提示消息。检查后可确认警报。",
    helpStatusBody: "正常表示设备运行稳定；警告表示使用率或负载偏高；严重表示需要立即处理；离线表示设备无响应。",
  ...
  ms: {
    ...
    helpAlertsBody: "Amaran bermaksud peranti perlukan perhatian. Kritikal bermaksud risiko servis tinggi. Info ialah mesej penyelenggaraan atau makluman. Sahkan selepas semakan.",
    helpStatusBody: "Sihat bermaksud peranti normal, amaran bermaksud penggunaan meningkat, kritikal perlu tindakan segera, dan luar talian bermaksud peranti tidak memberi respons.",
