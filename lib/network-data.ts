  ...
  const floors: FloorData[] = [
    {
      ...
      devices: [
        ...
        device({ id: "ap-102", name: "AP-Lobby-01", type: "access_point", status: "degraded", floor: 1, zone: "Lobby", room: "Main Lobby", ipAddress: "10.10.1.22", macAddress: "A8:5E:45:1B:20:12", model: "UniFi U6 Lite", firmware: "6.6.55", uptime: "45d 12h", lastSeen: "18 seconds ago", clients: 6, bandwidth: { up: 8, down: 18 }, location: { x: 61, y: 48 }, camera: { label: "Lobby camera C-02", image: "/camera/lobby.png", angle: "Wide lobby entrance view" }, maintenanceNotes: "Lobby AP is responding slowly after a PoE power fluctuation; check switch port and injector.", connectedTo: ["sw-101"] }),
    ...
    },
    {
      ...
      devices: [
        ...
        device({ id: "ap-202", name: "AP-Office-A2", type: "access_point", status: "degraded", floor: 2, zone: "Office Zone A", room: "Open Office A", ipAddress: "10.10.2.22", macAddress: "A8:5E:45:2B:20:12", model: "UniFi U6 Pro", firmware: "6.6.55", uptime: "30d 8h", lastSeen: "9 seconds ago", clients: 52, bandwidth: { up: 180, down: 380 }, location: { x: 63, y: 36 }, camera: { label: "Office camera C-12", image: "/camera/office.png", angle: "Open office west aisle" }, maintenanceNotes: "High client load; consider adding one AP near hot desk zone.", connectedTo: ["sw-201"] }),
    ...
    },
    {
      ...
      devices: [
        ...
        device({ id: "srv-402", name: "SRV-App-01", type: "server", status: "degraded", floor: 4, zone: "Server Room", room: "Server Room", rack: "Rack S2 / U10", ipAddress: "10.10.4.102", macAddress: "3C:EC:EF:91:10:02", model: "Dell PowerEdge R450", firmware: "iDRAC 7.10", uptime: "180d 15h", lastSeen: "6 seconds ago", cpu: 78, memory: 85, temperature: 49, location: { x: 75, y: 62 }, camera: { label: "Server room C-33", image: "/camera/server-room.png", angle: "Server rack S2 front view" }, maintenanceNotes: "CPU and memory elevated; review application worker queue.", connectedTo: ["sw-401"] }),
        device({ id: "srv-403", name: "SRV-File-01", type: "server", status: "degraded", floor: 4, zone: "Server Room", room: "Server Room", rack: "Rack S2 / U12", ipAddress: "10.10.4.103", macAddress: "3C:EC:EF:91:10:03", model: "Dell PowerEdge R550", firmware: "iDRAC 7.10", uptime: "180d 15h", lastSeen: "12 seconds ago", cpu: 68, memory: 81, temperature: 47, location: { x: 80, y: 72 }, camera: { label: "Server room C-34", image: "/camera/server-room.png", angle: "Storage rack view" }, maintenanceNotes: "Storage volume is near capacity and backup jobs are running slower than normal.", connectedTo: ["sw-401"] }),
      ],
      totalClients: 28,
