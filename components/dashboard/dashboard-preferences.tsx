...
const TRANSLATIONS = {
  en: {
    ...
    helpStatusBody: "Healthy devices are operating normally, degraded devices have elevated usage, load, or link issues, and down devices need immediate attention or are not responding.",
  ...
  zh: {
    ...
    helpStatusBody: "正常表示设备运行稳定；降级表示使用率、负载或链路异常；故障表示需要立即处理或设备无响应。",
  ...
  ms: {
    ...
    helpStatusBody: "Sihat bermaksud peranti normal, merosot bermaksud penggunaan, beban, atau pautan bermasalah, dan tergendala bermaksud perlu tindakan segera atau peranti tidak memberi respons.",
